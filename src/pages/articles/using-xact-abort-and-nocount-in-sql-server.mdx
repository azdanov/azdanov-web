...
Main resource that I used to learn more about these statements were from an article by Erland Sommarskog - Error and Transaction Handling in SQL Server: https://www.sommarskog.se/error_handling/Part1.html#jumpXACT_ABORT
