...
export const meta = {
  ...
  description: "My first steps in learning how to build RESTful APIs with C#, .NET 7, Dapper and PostgreSQL",
};
...
<Image src={restfulCertificatePng} alt="Certificate for completing From Zero to Hero:
REST APIs in .NET" />
