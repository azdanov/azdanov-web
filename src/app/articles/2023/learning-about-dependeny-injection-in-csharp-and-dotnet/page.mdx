...
import dependencyInjection from "./dependency-injection-csharp-certificate.png";
...
I already finished his course about [REST APIs in .NET](https://www.azdanov.dev/articles/2023/first-steps-restful-api-dotnet), and I wasn't disappointed in the new course also.
